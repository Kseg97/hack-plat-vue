    ...
    <div class="container">
      <div class="row row-grid justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="display-3">
            You like to live incredible experiences
            <span
              class="text-success"
            >Learn more about how a hackathon experience is lived</span>
          </h2>
          <p
            class="lead"
          >With whom we work they try to solve great challenges and challenges that seek to solve and help solve problems of human life. Meet our allies below.</p>
          <div class="text-center">
            <h4 class="display-4 mb-5 mt-5">Our Allies</h4>
