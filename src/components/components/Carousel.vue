    ...
    <div class="container py-0 pb-lg">
      <div class="row justify-content-between align-items-center">
        <div class="col-lg-5 mb-5 mb-lg-0">
          <h1 class="text-white font-weight-light">Better than before.</h1>
          <p
            class="lead text-white mt-4"
          >Live new experiences with hackathons working hand in hand and communicating in the best way with all teams.</p>
          <a
